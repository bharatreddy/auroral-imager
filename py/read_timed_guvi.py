...
if __name__ == "__main__":
    inpDirs = [ "/home/bharat/Documents/code/data/timed-temp/20050806/" ]
    inpDate = datetime.datetime( 2005, 8, 6 )
    outDir = "/home/bharat/Documents/code/data/timed-prcsd"
    tgRdObj = read_timed_guvi.ProcessTGData( inpDirs, outDir, inpDate )
